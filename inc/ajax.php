...
add_action( 'wp_ajax_nopriv_sunset_save_user_contact_form', 'sunset_save_contact_form_info' );
add_action( 'wp_ajax_sunset_save_user_contact_form', 'sunset_save_contact_form_info' );
...
function sunset_save_contact_form_info() {
